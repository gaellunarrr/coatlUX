      ...
      <ScrollView className="flex-1 bg-gray-50 p-4">
        ...
        <View className="space-y-4">
          ...
          <Link href="/(tabs)/ventas" asChild>
            <Pressable className="flex-row items-center justify-between rounded-2xl bg-blue-600 p-6 shadow-md">
          ...
          <Link href="/(tabs)/inventario" asChild>
            <Pressable className="flex-row items-center rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
